...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_GROUPS = useMemo(() => {
    const groups = [
      ...
      { id: 'sales', title: "Sales Terminal", icon: Zap, color: "text-rose-400", items: [{ name: "New Order", key: "new_order", href: '/admin/orders/create', icon: Plus, visible: productsEnabled }, { name: "New Booking", key: "new_booking", href: '/admin/bookings/create', icon: Plus, visible: servicesEnabled }, { name: "Quotations", key: "quotations", href: '/admin/quotations', icon: FileSpreadsheet }, { name: "Sales Leads", key: "leads", href: '/admin/leads', icon: TrendingUp }].filter(i => i.visible !== false) },
