    ...
    <div className="bg-[#F2F4F8] min-h-screen py-4 md:py-8 pb-32 md:pb-16">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        >
          ...
          <div className="px-12 py-6 flex-1 flex flex-col min-h-0 overflow-hidden" style={{ marginTop: `${d.sectionSpacing}px` }}>
            ...
            <div className={cn("overflow-hidden rounded-xl mb-4 shrink-0 avoid-break", d.showGridLines ? "border-2 border-[#081621]" : "border-none shadow-sm")}>
              <table className="w-full border-collapse text-[10px]">
                <thead className="bg-[#081621] text-white">
                  <tr>
                    <th className="py-2 px-4 font-black uppercase text-left w-10">SL</th>
                    <th className="py-2 px-4 font-black uppercase text-left">Description</th>
                    <th className="py-2 px-4 font-black uppercase text-center w-24">Unit/Area</th>
                    <th className="py-2 px-4 font-black uppercase text-right w-24">Rate</th>
                    <th className="py-2 px-4 font-black uppercase text-right w-28">Total</th>
                  </tr>
                </thead>
                <tbody className="font-bold bg-white">
                  ...
                  <tr className="border-t-2 border-[#081621] bg-gray-50/50 break-inside-avoid">
            ...
            <div className="p-2 bg-gray-50 rounded-xl border-2 border-gray-100 flex flex-col gap-0.5 text-left mb-6 shrink-0 shadow-inner">
              <p className="text-[7px] font-black text-gray-400 uppercase tracking-[0.3em]">Total Amount (In words):</p>
              <p className="text-[10px] font-black text-[#081621] italic leading-none">"{numberToWords(parseFloat(invoice.total) || 0)}"</p>
            </div>

            <div className="space-y-1.5 shrink-0 overflow-hidden avoid-break">
            ...
            <div className="mt-auto grid grid-cols-2 gap-32 items-end pt-4 pb-2 shrink-0 avoid-break" style={{ marginTop: `${d.signatureSpacing}px` }}>
          ...
          <footer className="pt-2 border-t border-gray-100 px-12 shrink-0 overflow-hidden" style={{ marginTop: `${d.footerMarginTop}px`, paddingBottom: `${d.footerPaddingBottom}px` }}>
