      ...
      <div className="flex items-center justify-between h-full px-2 relative">
        ...
        <div className="flex-1 flex justify-center relative h-full">
          <div className="absolute -top-6">
            <Link 
              href="/" 
              className="bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-3 rounded-full shadow-[0_8px_16px_rgba(34,99,192,0.4)] border-4 border-[#081621] flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
            >
