    ...
    <div className="space-y-8 pb-24 max-w-6xl mx-auto min-w-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-12 overflow-x-auto no-scrollbar flex justify-center pb-10">
          ...
          >
            {/* 🖼️ CORPORATE HEADER */}
            <div className="pt-6 px-10 pb-4 flex justify-between items-start border-b-2 border-gray-100 shrink-0">
            ...
            <div className="px-10 pt-4 space-y-3 flex-1 relative z-10">
               ...
               <div className="p-2.5 bg-[#1E5F7A]/5 rounded-xl border border-[#081621] flex flex-col gap-0.5 text-left">
               ...
               <div className="p-3 bg-gray-50 rounded-xl border border-gray-200" style={{ pageBreakInside: 'avoid' }}>
            ...
            {/* 🖋️ SIGNATURES */}
            <div className="px-10 py-5 grid grid-cols-2 gap-20 items-end shrink-0" style={{ pageBreakInside: 'avoid' }}>
            ...
            <div className="px-10 pt-3 pb-3 border-t border-gray-100 bg-gray-50/30 shrink-0" style={{ pageBreakInside: 'avoid' }}>
            ...
            <div className="pt-2 text-center space-y-0.5 mb-2 shrink-0" style={{ pageBreakInside: 'avoid' }}>
              ...
              <p className="text-[7px] text-gray-400 font-bold uppercase tracking-widest">We look forward to serving you again.</p>
            </div>

            <div className="pb-2 w-full text-center shrink-0">
               <p className="text-[6.5px] text-gray-300 uppercase font-bold">{footerDisclaimer}</p>
            </div>
          </div>
        </div>
      </div>
