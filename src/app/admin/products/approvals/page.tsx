...
export default function ProductApprovalsPage() {
  ...
  // 🛡️ Fixed Index Error: Removed 'where' clause to avoid composite index requirement.
  ...
  const pendingProducts = useMemo(() => {
    return allProducts?.filter(p => p.approvalStatus === 'Pending') || [];
  }, [allProducts]);
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-none shadow-sm bg-orange-50 text-orange-700">
          <CardContent className="p-6 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-black">{pendingProducts.length}</h3>
            </div>
        ...
        <Card className="border-none shadow-sm bg-blue-50 text-blue-700">
          <CardContent className="p-6 flex items-center justify-between">
            <div>
              <p className="text-blue-700/80 text-[10px] font-black uppercase tracking-widest leading-none mb-1">Status</p>
        ...
        <Card className="border-none shadow-sm bg-[#081621] text-white">
          <CardContent className="p-6 flex items-center justify-between">
            <div>
              <p className="text-white/60 text-[10px] font-black uppercase tracking-widest leading-none mb-1">Review Speed</p>
        ...
        <CardContent className="p-0 overflow-x-auto">
          <Table>
            <TableHeader className="bg-gray-50/50">
              <TableRow>
                <TableHead className="font-bold py-5 pl-8 uppercase text-[10px] tracking-widest">Product Preview</TableHead>
                <TableHead className="font-bold uppercase text-[10px] tracking-widest">Vendor Info</TableHead>
                <TableHead className="font-bold uppercase text-[10px] tracking-widest">Category</TableHead>
                <TableHead className="font-bold uppercase text-[10px] tracking-widest">Price Point</TableHead>
