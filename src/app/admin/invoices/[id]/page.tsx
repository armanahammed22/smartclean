      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-12 overflow-x-auto no-scrollbar flex justify-center pb-10">
          ...
          >
            ...
            <div className="px-12 pt-4 space-y-4 flex-1 relative z-10">
               ...
               <div className="flex justify-between items-start">
                  ...
                  <div className="text-right space-y-3">
                    <div className="space-y-0.5">
                        <p className="text-[8.5px] font-black text-[#1E5F7A] uppercase tracking-widest">Doc Reference</p>
                        <p className="text-sm font-black text-[#081621] font-mono tracking-tighter">{invoice.invoiceNumber}</p>
                    </div>
                    <div className="space-y-0.5">
                        <p className="text-[8.5px] font-black text-[#1E5F7A] uppercase tracking-widest">Date</p>
                    ...
                    <tbody className="text-[10px] font-medium bg-white">
                      ...
                      {invoice.discount > 0 && (
                        <tr className="border-t border-[#081621] bg-white">
                          <td colSpan={4} className="py-1.5 px-6 text-right font-black uppercase text-[8.5px] border-r border-[#081621] text-rose-600">Discount (-)</td>
                      ...
                      <tr className="border-t border-[#081621] bg-emerald-50/50">
                        <td colSpan={4} className="py-1.5 px-6 text-right font-black uppercase text-[8.5px] border-r border-[#081621] text-emerald-700 italic">Total Received Amount</td>
               ...
               <div className="p-3 bg-[#1E5F7A]/5 rounded-xl border border-[#081621] flex flex-col gap-0.5 text-left">
                  <p className="text-[7px] font-black uppercase text-gray-400 tracking-widest">In Words:</p>
                ...
                <div className="flex flex-col items-center justify-end text-center space-y-3">
                   <div className="h-10 w-24 relative border-b border-gray-100 pb-1 flex items-center justify-center">
                        {signatureUrl ? (
                          ...
                          <div className="text-[7px] font-black text-gray-200 border border-dashed p-1 uppercase">Auth. Signature</div>
                        )}
                   </div>
                   <div>
            ...
            <div className="px-12 pt-3 pb-3 border-t border-gray-100 bg-gray-50/30" style={{ pageBreakInside: 'avoid' }}>
