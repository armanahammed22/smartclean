...
function InvoiceViewContent() {
  ...
  const headerAddress = settings?.invoiceHeaderAddress || settings?.address || 'GP.JA-66/2, Wireless Gate, Mohakhali, Dhaka';
  ...
  return (
    <div className="bg-[#F2F4F8] min-h-screen py-4 md:py-12 pb-32 md:pb-16 selection:bg-primary selection:text-white">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        >
          {statusSealUrl && (
            <div className="absolute top-48 right-16 z-50 opacity-20 rotate-12 pointer-events-none w-48 h-48">
              <Image src={statusSealUrl} alt="Status" fill className="object-contain" unoptimized />
            </div>
          )}
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <header className="px-12 flex justify-between items-start border-b-[3px] border-gray-100 shrink-0" style={{ paddingTop: `${d.headerPaddingTop}px`, paddingBottom: `${d.headerPaddingBottom}px` }}>
              <div className="flex gap-6">
                ...
                <div className="space-y-1 text-left flex flex-col justify-center">
                  ...
                  <p className="text-[8px] font-bold text-primary uppercase tracking-widest">Premium Care Provider</p>
                </div>
              </div>
            ...
            <div className="px-12 py-6 space-y-4 flex-1 overflow-hidden" style={{ marginTop: `${d.sectionSpacing}px` }}>
              <div className="text-center space-y-0.5 shrink-0"><h3 className="text-xl font-black uppercase tracking-tighter italic text-[#081621]">Tax Invoice</h3><div className="h-1 w-16 mx-auto rounded-full" style={{ backgroundColor: d.primaryColor }} /></div>
              ...
              <div className="flex justify-between items-start shrink-0 mb-6">
                ...
                <div className="text-right space-y-4">
                  <div><p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Invoice Ref.</p><p className="text-base font-black text-[#081621] font-mono tracking-tighter">{invoice.invoiceNumber}</p></div>
                  <div><p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Issued On</p><p className="text-[10px] font-black text-[#081621]">{invoice.createdAt ? format(new Date(invoice.createdAt), 'dd MMM yyyy') : 'N/A'}</p></div>
                </div>
              </div>
              ...
              <div className="p-2 bg-gray-50 rounded-xl border border-gray-100 flex flex-col gap-0.5 text-left shrink-0 shadow-inner">
                <p className="text-[7px] font-black text-gray-400 uppercase tracking-[0.3em]">Total Amount (In words):</p>
              ...
              <div className="grid grid-cols-2 gap-32 items-end pt-4 pb-2 shrink-0" style={{ marginTop: `${d.signatureSpacing}px` }}>
                <div className="text-center space-y-1.5"><div className="border-b-[2px] border-gray-100 h-6"></div><p className="text-[9px] font-black uppercase text-[#081621]">Recipient Signature</p></div>
          ...
          <footer className="pt-2 border-t border-gray-100 px-12 shrink-0" style={{ marginTop: `${d.footerMarginTop}px`, paddingBottom: `${d.footerPaddingBottom}px` }}>
            ...
            <p className="text-[7.5px] text-gray-300 font-bold uppercase text-center mt-4 tracking-[0.3em]">{settings?.invoiceFooterDisclaimer || "ELECTRONICALLY VERIFIED DOCUMENT"}</p>
          </footer>
        </div>
      </div>
    </div>
