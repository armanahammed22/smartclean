  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 leading-tight">Tracking Master Control</h1>
          <p className="text-muted-foreground text-sm font-medium">Global behavioral switch for all marketplace tracking pipes</p>
        </div>
          ...
          <Card className="border-none shadow-sm bg-white rounded-3xl overflow-hidden border border-gray-100">
            <CardHeader className="p-8 pb-4">
              <CardTitle className="text-base font-bold flex items-center gap-2">
                <Globe size={18} className="text-primary" /> Tracking Ethics
              </CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0 space-y-4">
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-[11px] font-medium text-gray-600 leading-relaxed italic">
                "Our system utilizes SHA-256 hashing for all user-identifiable data (PII) before transmission to external platforms."
              </div>
              <div className="flex items-start gap-3 p-4 bg-red-50 rounded-xl border border-red-100">
                <AlertTriangle size={18} className="text-red-600 shrink-0" />
                <p className="text-[10px] font-bold text-red-700 leading-normal">
                  Warning: Disabling Global Tracking will stop all ad attribution data.
                </p>
              </div>
            </CardContent>
          </Card>
