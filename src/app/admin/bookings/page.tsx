            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-gray-50/50 p-6 md:p-8 rounded-[2rem] border border-gray-100 flex flex-col gap-8 h-fit">
                  <div className="space-y-4">
                    <h3 className="text-sm font-black uppercase tracking-widest text-primary flex items-center gap-2"><Wallet size={16} /> বুকিং সামারি</h3>
                    <div className="space-y-3">
                  ...
                  <div className="space-y-4 pt-4 border-t">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Wrench size={20} className={paymentCategory === 'cod' ? "text-primary" : "text-gray-400"} />
