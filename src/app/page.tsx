                      ...
                      <div className="relative aspect-[982/500] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10 group bg-gray-100">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-8 md:p-16">
                           <div className="max-w-xl space-y-4">
                              ...
                              <Button asChild size="lg" className="h-14 px-10 rounded-2xl font-black text-lg shadow-2xl bg-primary text-white border-none hover:bg-primary/90">
        ...
        {(!marqueeSettings || marqueeSettings.enabled) && (
          <section className="container mx-auto px-4">
            <div className={cn(
              ...
              marqueeSettings?.radius || "rounded-[1.25rem]",
              ...
              <div className="flex-1 overflow-hidden relative h-full flex items-center">
                 <div className={cn(
                   ...
                   {marqueeSettings?.ctaText && marqueeSettings?.ctaLink && (
                     <Link href={marqueeSettings.ctaLink} className="px-4 py-1.5 rounded-xl text-[10px] uppercase font-black bg-white text-gray-900 shadow-lg">
        ...
        <div className="container mx-auto px-4 space-y-24 mt-12">
          ...
          <section className="space-y-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-primary/10 pb-8">
              ...
              <Button variant="outline" className="gap-2 font-black uppercase text-xs tracking-widest border-primary/20 text-primary rounded-2xl h-12 px-8 hover:bg-primary/5 shadow-sm" asChild>
            ...
            {servicesLoading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-8">
                {services?.map((service) => (
                  <div key={service.id} className="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-[0_20px_50px_rgba(34,99,192,0.1)] transition-all duration-700 border border-transparent hover:border-primary/20 flex flex-col relative h-full">
                    <Link href={`/service/${service.id}`} className="block relative aspect-square overflow-hidden shrink-0">
                      ...
                      <div className="absolute top-4 left-4">
                        <Badge className="bg-white/95 text-primary border-none shadow-xl backdrop-blur-md font-black text-[9px] uppercase px-3 py-1 rounded-xl">{service.categoryId || 'General'}</Badge>
                      </div>
                    </Link>
                    <div className="p-6 flex flex-col flex-1 gap-4">
                      ...
                      <div className="flex flex-col border-t border-gray-50 pt-4 gap-4 mt-auto">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="p-2 bg-gray-50 rounded-xl text-gray-400"><Wrench size={16} /></div>
                        </div>
                        <Button size="lg" className="w-full rounded-[1.25rem] font-black text-xs uppercase shadow-xl h-12 tracking-widest transition-all hover:translate-y-[-2px] active:scale-95" asChild>
