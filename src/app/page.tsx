...
export default function SmartCleanHomePage() {
  ...
  const getGridCols = (cols: string | undefined) => {
    ...
    if (c === '5') return 'grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6';
    if (c === '6') return 'grid-cols-2 md:grid-cols-4 lg:grid-cols-6';
                          ...
                          <CarouselItem key={banner.id} className="h-full basis-full relative pl-0">
                            <Link href={banner.buttonLink || '#'} className="block w-full h-full relative">
                              ...
                              <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center p-3 sm:p-6 md:p-12 text-left">
                                ...
                                <Button size="sm" className="w-fit h-6 sm:h-8 md:h-10 rounded-full px-3 sm:px-4 md:px-6 font-black uppercase text-[7px] sm:text-[10px] md:text-xs shadow-lg" style={{ backgroundColor: banner.buttonColor }}>
