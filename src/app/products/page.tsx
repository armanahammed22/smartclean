...
import { Loader2, Package, ShoppingCart, ArrowRight, Tag } from 'lucide-react';
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {products?.map((product) => (
                <div key={product.id} className="bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-gray-50 text-gray-400 rounded-xl"><Package size={24} /></div>
                      ...
                      <div className="flex items-center gap-3 pt-2">
                        <Badge variant="secondary" className="text-[9px] font-black uppercase bg-gray-50 text-gray-500 border-none">{product.categoryId}</Badge>
