...
import { Loader2, Wrench, Clock, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-[#F9FAFB] min-h-screen py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="space-y-4 mb-12 text-center">
            <Badge className="bg-primary/10 text-primary border-none uppercase tracking-widest font-black py-1 px-4 rounded-none">Our Expertise</Badge>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {services?.map((service) => (
                <div key={service.id} className="bg-white p-6 md:p-8 rounded-none border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex-1 space-y-3">
                      <div className="flex items-center gap-3">
                        <div className="p-2 bg-primary/5 text-primary rounded-none"><Wrench size={24} /></div>
                      ...
                      <div className="flex items-center gap-4 pt-2">
                        ...
                        <Badge variant="outline" className="text-[9px] font-black border-primary/20 text-primary px-2 py-0 rounded-none">{service.categoryId}</Badge>
                      </div>
                    </div>
