...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_GROUPS = useMemo(() => {
    const groups = [
      ...
      { id: 'sales', title: "Sales Terminal", icon: Zap, color: "text-rose-400", items: [{ name: "New Order", key: "new_order", href: '/admin/orders/create', icon: Plus, visible: productsEnabled }, { name: "New Booking", key: "new_booking", href: '/admin/bookings/create', icon: Plus, visible: servicesEnabled }, { name: "Sales Leads", key: "leads", href: '/admin/leads', icon: TrendingUp }].filter(i => i.visible !== false) },
      { id: 'orders', title: "Order & Booking", icon: ShoppingCart, color: "text-blue-400", items: [{ name: "Product Orders", key: "orders", href: '/admin/orders', icon: Package, visible: productsEnabled }, { name: "Service Bookings", key: "bookings", href: '/admin/bookings', icon: Calendar, visible: servicesEnabled }, { name: "Cleaning Projects", key: "projects", href: '/admin/projects', icon: Briefcase }, { name: "Invoices", key: "invoices", href: '/admin/invoices', icon: ReceiptText }, { name: "Logistics", key: "couriers", href: '/admin/couriers', icon: Truck, visible: productsEnabled }].filter(i => i.visible !== false) },
      ...
      { id: 'system', title: "SETTINGS", icon: Settings, color: "text-slate-300", items: [{ name: "Global Settings", key: "global_settings", href: '/admin/settings', icon: Settings }, { name: "Sidebar Design", key: "sidebar_appearance", href: '/admin/settings/appearance/sidebar', icon: Palette }, { name: "Payment Gateways", key: "payment_gateways", href: '/admin/payments', icon: Wallet }, { name: "Delivery Fees", key: "delivery_fees", href: '/admin/settings/delivery', icon: Truck }, { name: "Localization", key: "localization", href: '/admin/settings/languages', icon: Languages }] },
