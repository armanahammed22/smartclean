...
/**
 * 🛡️ SINGLE SEGMENT QUOTATION VIEW
 * Redirects or displays based on canonical ID logic.
 */
function QuotationViewContent() {
  ...
  return (
    <div className="bg-[#F2F4F8] min-h-screen py-4 md:py-12 selection:bg-primary selection:text-white">
      <style jsx global>{`
        @media print {
      ...
      <div className="container mx-auto px-4 flex flex-col items-center">
        <div className="w-full max-w-[210mm] flex flex-col sm:flex-row justify-between items-center mb-10 gap-6 px-4 no-print">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button variant="outline" className="rounded-xl gap-2 font-black uppercase text-[10px] h-12 px-6 border-emerald-200 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-all shadow-sm" style={{ backgroundColor: 'white' }}><MessageCircle size={18} /> Support</Button>
                ...
                <table className="w-full border-collapse text-[10px]">
                  <thead className="bg-[#081621] text-white">
                    <tr>
                      ...
                      <th className="py-2 px-4 font-black uppercase text-left">Service Components</th>
                      ...
                      <th className="py-2 px-4 font-black uppercase text-right w-28">Subtotal</th>
                    </tr>
                  </thead>
