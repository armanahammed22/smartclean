...
/**
 * 🛡️ REBORN QUOTATION VIEW (Single Segment)
 * Standardizes ID lookups and handles single-segment reference numbers.
 */
  ...
  useEffect(() => {
    async function fetchQuote() {
      ...
      try {
        ...
        // 1. Try fetching by quoteNumber (SEO URL)
              ...
              <div className="flex justify-between items-start shrink-0">
                <div className="text-left space-y-3">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-xl font-black text-[#081621] uppercase tracking-tight" style={{ fontSize: `${d.bodyFontSize + 2}px` }}>{quote.customerInfo?.name}</h4>
...
export default function SingleQuotationView() {
  return (
